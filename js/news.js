...
function crearNoticias(json){
	$.each(json, function(i,noticia){
		$("#noticias").append("<div class='well'><h2>"+noticia.titulo+"</h2><p class='text-info'>"+noticia.datetime+"</p> \
			<div class='row'><div class='col-sm-3'><img class='img-thumbnail img-responsive' \
